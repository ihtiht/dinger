...
internal class AppAccountAuthenticator(context: Context)
    ...
    override fun isThereALoggedInUser() = getAccountTinderToken() != null

    fun getAccountTinderToken() = delegate.getAccountsByType(Companion.ACCOUNT_TYPE).let {
        when (it.size) {
            0 -> null
